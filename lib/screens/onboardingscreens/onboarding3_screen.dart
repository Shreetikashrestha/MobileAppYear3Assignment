...
class _OnboardingScreen3State extends State<OnboardingScreen3> {
  ...
  final List<String> ethnicities = ['Asian', 'Black', 'Hispanic', 'White', 'Middle Eastern', 'Mixed', 'Other'];
  final List<String> languages = ['English', 'Spanish', 'French', 'German', 'Chinese', 'Japanese', 'Korean', 'Hindi', 'Arabic'];
